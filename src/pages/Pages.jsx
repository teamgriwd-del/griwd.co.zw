...
const PageLayout = ({ title, children, colorClass = "from-brand-blue to-brand-purple", subtitle, hiddenCircles = [] }) => (
  <div className="pt-48 pb-32 px-6 min-h-screen bg-brand-light relative overflow-hidden">
    {/* Background Decorative Elements */}
    <div className={`absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br ${colorClass} opacity-[0.05] blur-[150px] -z-10`} />
    
    {/* Background Animation - Lowered to not hinder nav tiles */}
    <div className="absolute top-40 -right-20 opacity-30 z-0 pointer-events-none">
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      <div className="mb-24">
        <motion.div
          ...
          className="text-brand-blue font-black tracking-[0.3em] uppercase text-xs mb-6"
        >
          GRIWD Solutions
        </motion.div>
        <motion.h1 
          ...
          className="text-6xl md:text-[10rem] font-heading leading-[0.8] tracking-[-0.06em] mb-12 text-white"
        >
          {title.toUpperCase()}
        </motion.h1>
        {subtitle && (
          <motion.p 
            ...
            className="text-slate-400 text-2xl max-w-2xl leading-relaxed"
          >
            {subtitle}
          </motion.p>
        )}
    ...
    >
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-2 gap-8">
            {[
              ...
              <div key={stat.t}>
                <div className="text-4xl font-heading text-brand-blue mb-1">{stat.n}</div>
                <div className="text-xs font-black tracking-widest uppercase text-slate-500">{stat.t}</div>
              </div>
            ))}
          </div>
        </div>
        <div className="p-16 glass rounded-[4rem] border-white/5 relative group">
          <div className="absolute inset-0 bg-brand-blue/5 rounded-[4rem] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
          <h3 className="text-3xl font-heading mb-8 text-white">Our Pulse</h3>
          <p className="text-slate-400 text-xl leading-relaxed mb-10">
            "To deliver creative and technical solutions that empower businesses through uncompromised reliability."
          </p>
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center overflow-hidden p-2 shadow-xl">
              <img src={logo} alt="GRIWD" className="w-full h-full object-contain" />
            </div>
            <div>
              <div className="font-heading text-white">GRIWD CORE</div>
              <div className="text-xs text-brand-blue font-black uppercase tracking-tighter">Mission Statement</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-48">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-20">
          <h2 className="text-5xl md:text-7xl font-heading text-white mb-6 uppercase tracking-tighter">Our Journey</h2>
          <div className="w-32 h-2 bg-brand-blue" />
          <p className="text-slate-400 text-2xl mt-8 max-w-2xl">A glimpse into the elite craftsmanship and moments that define GRIWD.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {aboutGalleryImages.map((img, i) => (
            ...
            >
              <img src={img} alt="About Moment" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700 grayscale group-hover:grayscale-0" />
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          <motion.div 
            ...
            className="p-12 glass rounded-[3rem] group hover:border-brand-orange/30 transition-all duration-700"
          >
            <item.icon className="text-brand-orange mb-8 group-hover:scale-110 transition-transform" size={48} />
            <h3 className="text-3xl font-heading mb-4 text-white">{item.t}</h3>
...
export const Repairs = () => {
  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-10">
        {[
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, x: 0 }}
            className="p-16 glass rounded-[4rem] group hover:border-brand-green/30 transition-all duration-700"
          >
            <div className="flex justify-between items-start mb-10">
              <item.icon className="text-brand-green" size={56} />
              <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center font-heading text-white/20 group-hover:text-brand-green group-hover:border-brand-green/50 transition-all">
                0{i+1}
              </div>
            </div>
            <h3 className="text-4xl font-heading mb-6 text-white">{item.t}</h3>
            <p className="text-slate-400 text-xl leading-relaxed">{item.d}</p>
          </motion.div>
        ))}
      </div>
      ...
      <div className="mt-48">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-20">
          <h2 className="text-5xl md:text-7xl font-heading text-white mb-6 uppercase tracking-tighter">Hardware Lab</h2>
          <div className="w-32 h-2 bg-brand-green" />
          <p className="text-slate-400 text-2xl mt-8 max-w-2xl">Behind the scenes of our elite system optimizations and precision repairs.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {repairGalleryImages.map((img, i) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              onClick={() => setSelectedIdx(i)}
              className="group relative aspect-square overflow-hidden rounded-[2rem] bg-slate-900 border border-white/5 cursor-pointer"
            >
              <img src={img} alt="Repair Work" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700 grayscale group-hover:grayscale-0" />
...
export const Networking = () => (
  <PageLayout 
    ...
    hiddenCircles={["Tech"]}
  >
    <div className="p-20 glass rounded-[5rem] border-white/5 group relative overflow-hidden shadow-2xl">
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand-blue/10 blur-[120px] -z-10" />
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        <div>
          <h2 className="text-5xl font-heading mb-10 text-white leading-tight">Elite Connectivity Solutions</h2>
          <p className="text-slate-400 text-2xl leading-relaxed mb-12">We provide complete, structured networking for modern homes and elite business environments.</p>
          <div className="space-y-6">
            {[
              ...
              <div key={item} className="flex items-center gap-4 text-white text-xl font-bold">
                <CheckCircle2 className="text-brand-blue" /> {item}
              </div>
            ))}
          </div>
        </div>
        <div className="relative">
          <div className="p-12 glass rounded-[3rem] border-white/10 text-center">
            <Globe size={120} className="mx-auto text-brand-blue mb-8 animate-pulse-slow" />
            <div className="text-6xl font-heading text-white mb-2">360°</div>
            <div className="text-brand-blue font-black tracking-widest uppercase text-sm">Network Integrity</div>
          </div>
        </div>
      </div>
    </div>
...
export const WebDev = () => (
  ...
  >
    <div className="grid md:grid-cols-2 gap-10">
      <div className="p-16 glass rounded-[4rem] group hover:border-brand-purple/30 transition-all duration-700 shadow-2xl">
        <Laptop className="text-brand-purple mb-10" size={64} />
        <h3 className="text-5xl font-heading mb-8 text-white">Development</h3>
        <p className="text-slate-400 text-2xl leading-relaxed mb-10">Modern, ultra-responsive, and fast-loading websites built with cutting-edge tech stacks.</p>
        <div className="h-[2px] w-full bg-white/5 group-hover:bg-brand-purple/30 transition-all" />
      </div>
      <div className="p-16 glass rounded-[4rem] group hover:border-brand-red/30 transition-all duration-700 shadow-2xl">
        <Mail className="text-brand-red mb-10" size={64} />
        <h3 className="text-5xl font-heading mb-8 text-white">Ecosystem</h3>
        <p className="text-slate-400 text-2xl leading-relaxed mb-10">Reliable elite hosting and professional business email solutions that command respect.</p>
...
export const Internet = () => {
  ...
  return (
    ...
    >
      <div className="p-20 glass rounded-[5rem] text-center relative overflow-hidden shadow-2xl mb-32">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-green/5 blur-[150px] -z-10" />
        <h2 className="text-6xl font-heading text-white mb-8">Connected Everywhere</h2>
        <div className="grid md:grid-cols-3 gap-16 mt-24">
          {[
            ...
            <div key={item.t} className="space-y-6">
              <div className="w-24 h-24 rounded-3xl bg-white/5 flex items-center justify-center mx-auto text-brand-green shadow-xl overflow-hidden p-4">
                {item.isLogo ? (
                  <img src={logo} alt="GRIWD" className="w-full h-full object-contain" />
                ) : (
                  <item.icon size={48} />
              ...
              <h4 className="text-3xl font-heading text-white">{item.t}</h4>
              <p className="text-slate-400 text-lg leading-relaxed">{item.d}</p>
            </div>
          ))}
        </div>
      ...
      <div className="mt-48">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-20">
          <h2 className="text-5xl md:text-7xl font-heading text-white mb-6 uppercase tracking-tighter">Connectivity Deployment</h2>
          <div className="w-32 h-2 bg-brand-blue" />
          <p className="text-slate-400 text-2xl mt-8 max-w-2xl">High-speed infrastructure installations and starlink optimizations across Zimbabwe.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {internetGalleryItems.map((item, i) => (
            ...
            >
              {item.type === 'image' ? (
                <img src={item.src} alt="Connectivity Work" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700 grayscale group-hover:grayscale-0" />
              ) : (
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-blue/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute bottom-0 left-0 p-6 translate-y-10 group-hover:translate-y-0 transition-transform duration-500">
                 <div className="w-10 h-10 rounded-xl bg-brand-blue flex items-center justify-center text-white mb-3">
                    {item.type === 'image' ? <Globe size={20} /> : <Zap size={20} className="fill-white" />}
                 </div>
                 <div className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-blue mb-1">GRIWD CONNECT</div>
                 <div className="text-lg font-heading text-white">{item.type === 'image' ? 'Site Survey' : 'Active Deployment'}</div>
              </div>
            </motion.div>
          ))}
        </div>
  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-20">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-3xl px-8 py-6 text-white focus:border-brand-blue outline-none transition-all focus:bg-white/10" 
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-3xl px-8 py-6 text-white focus:border-brand-blue outline-none transition-all focus:bg-white/10 appearance-none"
                >
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/5 rounded-[2rem] px-8 py-6 text-white focus:border-brand-blue outline-none transition-all focus:bg-white/10 h-48" 
                placeholder="Tell us about your ambitions"
              ></textarea>
            </div>
            <button type="submit" className="group w-full py-8 rounded-[2rem] bg-brand-blue text-white font-heading text-xl flex items-center justify-center gap-4 hover:bg-white hover:text-brand-blue transition-all duration-500 shadow-2xl shadow-brand-blue/20">
          ...
          <AnimatePresence>
            {showNumberChoice && (
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.9 }}
                className="absolute inset-0 z-50 flex items-center justify-center p-4 bg-brand-light/80 backdrop-blur-xl rounded-[4rem]"
              >
                <div className="w-full max-w-sm space-y-6 text-center">
                  <h3 className="text-3xl font-heading text-white">Choose Chat Number</h3>
                  <div className="grid gap-4">
                    <button 
                      onClick={() => handleWhatsAppSend("263785919439")}
                      className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-brand-blue transition-all text-left group"
                    >
                      <div className="font-bold text-white text-lg">Team GRIWD 1</div>
                      <div className="text-xs text-slate-400 group-hover:text-white/80 uppercase tracking-widest font-black">Consultation & Sales</div>
                    </button>
                    <button 
                      onClick={() => handleWhatsAppSend("263786239765")}
                      className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-brand-blue transition-all text-left group"
                    >
                      <div className="font-bold text-white text-lg">Team GRIWD 2</div>
                      <div className="text-xs text-slate-400 group-hover:text-white/80 uppercase tracking-widest font-black">Support & Technical</div>
                    </button>
                  </div>
                  <button 
                    onClick={() => setShowNumberChoice(false)}
                    className="text-slate-500 hover:text-white uppercase font-black tracking-widest text-xs"
                  >
                    Cancel
                  </button>
                </div>
        ...
        <div className="space-y-12">
          <div className="p-16 glass rounded-[4rem] border-white/5 relative group h-full shadow-2xl">
            <div className="absolute inset-0 bg-brand-blue/5 rounded-[4rem] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
            <h4 className="text-4xl font-heading text-white mb-10">Contact Detail</h4>
            <p className="text-slate-400 text-xl leading-relaxed mb-16">Reach out to us for elite consultations and project quotes.</p>
            <div className="space-y-12">
              {[
                ...
                <a key={i} href={item.href} className="flex items-center gap-8 group/item hover:bg-white/5 p-4 -m-4 rounded-3xl transition-all">
                  <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center text-brand-blue group-hover/item:bg-brand-blue group-hover/item:text-white transition-all">
                    <item.icon size={32} />
                  </div>
                  <div>
                    <div className="text-xs font-black tracking-widest text-slate-500 uppercase mb-1">{item.t}</div>
                    <div className="text-2xl font-bold text-white group-hover/item:text-brand-blue transition-colors">{item.v}</div>
                  </div>
                </a>
              ))}
            </div>
