...
const WhyChooseUs = () => (
  <section className="py-32 px-6 glass border-y border-white/5 relative overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/5 to-brand-purple/5 -z-10" />
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
      <div>
        <h2 className="text-4xl md:text-6xl font-heading mb-8 leading-tight text-white">
        ...
        <div className="grid grid-cols-2 gap-8">
          {[
            ...
            <div key={stat.t}>
              ...
              <div className="text-sm font-black tracking-widest uppercase text-slate-500">{stat.t}</div>
            </div>
          ))}
        </div>
      </div>
      <div className="relative">
        ...
        <div className="p-12 glass rounded-[3rem] relative border-white/10">
          <h3 className="text-2xl font-heading mb-6 text-white">Our Core Commitment</h3>
