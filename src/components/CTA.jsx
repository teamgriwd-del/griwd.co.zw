...
export default function CTA() {
  return (
    <section className="py-20 md:py-40 px-6 text-center overflow-hidden relative">
      {/* Sun Glow Background */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <motion.h2 
          ...
          className="text-4xl sm:text-6xl md:text-[9rem] font-heading mb-12 tracking-[-0.05em] leading-[1] md:leading-[0.8] text-white"
        >
          CRAFT YOUR <br />
          <span className="text-brand-red drop-shadow-[0_0_30px_rgba(220,38,38,0.4)]">FUTURE.</span>
        </motion.h2>

        <p className="text-slate-400 text-lg md:text-2xl mb-16 max-w-xl mx-auto font-medium leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 md:gap-10 items-center">
          <Link 
            to="/contact" 
            className="group relative px-10 py-6 md:px-16 md:py-8 rounded-[1.5rem] md:rounded-[2.5rem] bg-brand-red text-white font-heading text-xl md:text-2xl hover:bg-white hover:text-brand-red transition-all duration-700 shadow-[0_20px_60px_rgba(220,38,38,0.4)]"
          >
